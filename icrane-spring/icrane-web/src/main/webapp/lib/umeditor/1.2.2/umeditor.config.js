...
(function() {
    ...
    window.UMEDITOR_CONFIG = {
        ...
        // 图片上传配置区
        ,
        imageUrl : path + "/imageUp.jsp" // 图片上传提交地址
        ,
        ...
        toolbar : [
                ...
                'link unlink | emotion image video | map |  paragraph fontfamily fontsize' ]

    // ,toolbar:[
    // 'source | undo redo | bold italic underline strikethrough | superscript
