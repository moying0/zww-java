...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 报修问题管理<span class="c-gray en">&gt;</span> 报修问题列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="${path}/dollRepairsManage/list" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<form id="frm" action="dollRepairsManage/list" method="post" >
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			...
			<%--<a class="btn btn-primary radius" data-title="添加报修问题设置" data-href="javascript:;" onclick="pref_add('添加报修问题设置','repairsManage/newPrefToAdd','','')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加申诉问题设置</a>--%>
		</span>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<tbody>
				<c:forEach items="${pageBean.list}" var="list">
					<tr class="text-c">
						...
						<td>${list.memberID }</td>
						<td>${list.name }</td>
						<td><img src="${list.tbimgRealPath }" width="80"></td>
						<td>${list.dollName }</td>
						<td>${list.machineCode }</td>
						<td>${list.machineStatus }</td>
						<td>${list.province }${list.city }${list.county }${list.street }</td>
						<td>${list.repairsReason }</td>
			...
			<tfoot>
			    <tr>
					...
					<jsp:param name= "page_url" value= "dollRepairsManage/list"/>
					</jsp:include>
					</td>
			    </tr>
			</tfoot>
