...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 统计管理<span class="c-gray en">&gt;</span> 新增用户日报列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="${path}/dollManage/list" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
            ...
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer">
                <table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
                    ...
                    <tr class="text-c">
                        ...
                        <th width="50" >日期</th>
                        <th width="50" >每日新增用户</th>
                        <th width="80">每日新增充值用户</th>
                        <th width="80">每日新增充值用户占比</th>
                        <th width="80">每日新增充值总额</th>
                        <th width="50">充值1.99新用户</th>
                    ...
                    <c:forEach items="${pageBean.list}" var="doll">
                        <tr class="text-c">
                            ...
                            <td class="f-14 td-manage"><a style="text-decoration:none" class="ml-5" onClick="dollImage_edit('娃娃机背景编辑','${path }/dollImageManage/list','${doll.name}','${doll.id }','','')" href="javascript:;" title="编辑背景图"><i class="Hui-iconfont">&#xe646;</i></a><a style="text-decoration:none" class="ml-5" onClick="doll_edit('娃娃机编辑','dollManage/toEditDoll','${doll.id}','','')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <%-- <a style="text-decoration:none" class="ml-5" onClick="doll_del(this,'${doll.id}')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a> --%></td>
                        </tr>
                    </c:forEach>
                    </tbody>
