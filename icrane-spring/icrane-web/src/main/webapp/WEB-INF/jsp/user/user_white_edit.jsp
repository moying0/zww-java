...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 管用户理<span class="c-gray en">&gt;</span> 修改白名单 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	...
	<form action="" method="post" class="form form-horizontal" id="form-product-add">
		 <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8">
				<input type="hidden" class="input-text" value="${member.id}" placeholder="" id="id" name="id">
				<input type="text" class="input-text" value="${member.userId}" placeholder="" id="userId" name="userId">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">用户id：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="${member.memberId}" placeholder="" id="memberId" name="memberId">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="${member.userIP}" placeholder="例：1" id="userIP" name="userIP">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>用户状态：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="${member.states}" placeholder="例：1" id="states" name="states">
			</div>
		</div>
		<div class="row cl">
