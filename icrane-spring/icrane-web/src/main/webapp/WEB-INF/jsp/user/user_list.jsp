...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 用户管理<span class="c-gray en">&gt;</span> 用户列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="${path}/memberManage/searchList" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<form id="frm" action="memberManage/searchList" method="post" >
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<tbody>
				<c:forEach items="${pageBean.list}" var="member"> 
					<tr class="text-c">
						...
						<td>${member.coins }</td>
						<td>${member.account.superTicket }</td>
						<td>${member.catchNumber }</td>
						...
						<td class="f-14 td-manage"><a style="text-decoration:none" class="ml-5" onClick="member_edit('用户编辑','memberManage/toEditMember','${member.id}','','')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <%-- <a style="text-decoration:none" class="ml-5" onClick="member_del(this,'${member.id}')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a> --%></td>
						<td>
							<a class="btn btn-primary radius" data-title="用户抓取记录查看" data-href="javascript:;" onclick="charge_query('用户抓取记录','memberManage/listCatch','${member.id}','','')" href="javascript:;">查看</a>
						</td>
						<td>
							<a class="btn btn-primary radius" data-title="用户充值记录查看" data-href="javascript:;" onclick="charge_query('用户充值记录','memberManage/listCharge','${member.id}','','')" href="javascript:;">查看</a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
			<tfoot>
			    <tr>
					...
					<jsp:param name= "page_url" value= "memberManage/searchList"/>
					</jsp:include>
					</td>
			    </tr>
			</tfoot>
