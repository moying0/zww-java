...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 用户管理<span class="c-gray en">&gt;</span> 充值订单列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="${path}/orderManage/searchList" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<form id="frm" action="orderManage/searchList" method="post" >
<div class="page-container">
	
	<!-- 筛选功能 div -text-c -->
	<div class="text-c">
	    <span>
			<input  name="memberName" id="memberName" value="${memberName}" placeholder="输入用户名" style="width:150px" class="input-text">
			<input  name="memberId" id="memberId" value="${memberId}" placeholder="输入用户id" style="width:150px" class="input-text">
			<select class="input-text" id="chargeName" value="${chargeName}" name="chargeName" style="width:150px">
			...
			<select class="input-text" id="charge_state" value="${charge_state}" name="charge_state" style="width:150px">
			...
			<input type="text" name="create_date" id="create_date" value="${create_date}"
				   ...
				   placeholder="输入开始时间" style="width:150px" class="input-text Wdate">
			<input type="text" name="endtime" id="endtime" value="${endtime}"
				   onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',readOnly:true})"
				   placeholder="输入结束时间" style="width:150px" class="input-text Wdate">
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<tfoot>
			    <tr>
					...
					<jsp:param name= "page_url" value= "orderManage/searchList"/>
					</jsp:include>
					</td>
			    </tr>
			</tfoot>
