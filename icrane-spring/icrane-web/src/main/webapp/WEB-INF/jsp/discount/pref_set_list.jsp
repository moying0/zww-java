...
<form id="frm" action="prefManage/list" method="post" >
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><!-- <a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> --> <a class="btn btn-primary radius" data-title="添加参数设置" data-href="javascript:;" onclick="pref_add('添加参数设置','prefManage/newPrefToAdd','','')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加参数设置</a></span> <%-- <span class="r">共有数据：<strong>${pageBean.totalCount }</strong> 条</span> --%> </div>
	<div class="mt-20">
			...
			<tbody>
				<c:forEach items="${prefList}" var="list"> 
					<tr class="text-c">
						...
						<td class="f-14 td-manage"><a style="text-decoration:none" class="ml-5" onClick="pref_edit('参数设置编辑','prefManage/toEditPref','${list.code}','','')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <%-- <a style="text-decoration:none" class="ml-5" onClick="pref_del(this,'${list.code}')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a> --%></td>
					</tr>
				</c:forEach>
			</tbody>
			<%-- <tfoot>
