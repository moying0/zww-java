...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 发货管理<span class="c-gray en">&gt;</span> 待发货列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="${path}/goodsManage/outDetailList" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<form id="frm" action="goodsManage/outDetailList" method="post" >
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<tbody>
				<c:forEach items="${pageBean.list}" var="order"> 
					<tr class="text-c">
						...
						<td><fmt:formatDate value='${order.modifiedDate }' pattern='yyyy-MM-dd HH:mm:ss'/></td>
			...
			<tfoot>
			    <tr>
					...
					<jsp:param name= "page_url" value= "goodsManage/outDetailList"/>
					</jsp:include>
					</td>
			    </tr>
			</tfoot>
