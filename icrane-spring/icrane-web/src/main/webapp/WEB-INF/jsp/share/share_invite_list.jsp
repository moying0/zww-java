...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 邀请管理<span class="c-gray en">&gt;</span> 邀请人列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="${path}/ShareInviteManage/list" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<form id="frm" action="ShareInviteManage/list" method="post" >
<div class="page-container">
	...
	<div class="text-c"> 
	    <span>
			...
			<input type="text" name="registerDate" id="registerDate"
				   value="${registerDate}"
				   onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})" placeholder="输入邀请人注册时间" style="width:150px"  class="input-text Wdate">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><!-- <a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> --> </span>
		<span class="l">邀请人：<strong>${pageBean.totalCount }</strong> 人</span>
		<span class="l" style="margin-left: 150px">被邀请人：<strong>${totalVisit }</strong> 人</span>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<tbody>
				<c:forEach items="${pageBean.list}" var="member"> 
					<tr class="text-c">
						...
						<td>
							<a class="btn btn-primary radius" data-title="被邀请人" data-href="javascript:;" onclick="charge_query('被邀请人','ShareInviteManage/shareInvite','${member.id}','','')" href="javascript:;">查看</a>
						</td>
						<td>
							<a class="btn btn-primary radius" data-title="充值记录查看" data-href="javascript:;" onclick="charge_query('用户充值记录','memberManage/listCharge','${member.id}','','')" href="javascript:;">查看</a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
			<tfoot>
			    <tr>
					...
					<jsp:param name= "page_url" value= "ShareInviteManage/list"/>
					</jsp:include>
					</td>
			    </tr>
			</tfoot>
