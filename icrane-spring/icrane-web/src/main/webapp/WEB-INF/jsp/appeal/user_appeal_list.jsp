...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 用户申诉管理<span class="c-gray en">&gt;</span> 用户列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="${path}/memberAppealManage/list" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<form id="frm" action="memberAppealManage/list" method="post" >
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<tbody>
				<c:forEach items="${pageBean.list}" var="member"> 
					<tr class="text-c">
						...
						<td><a style="text-decoration: underline;" onClick="palyer('视频播放','memberAppealManage/player','${member.videoURL }','','')" href="javascript:;" title="详情">${member.videoURL }</a></td>
						<td>${member.complaintReason }</td>
						<%--<td>${member.checkState }</td>--%>
			...
			<tfoot>
			    <tr>
					...
					<jsp:param name= "page_url" value= "memberAppealManage/list"/>
					</jsp:include>
					</td>
			    </tr>
			</tfoot>
...
/*视频弹窗*/
function palyer(title,url,players,w,h){
    url = url+"?players="+players;
