...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 申诉问题管理<span class="c-gray en">&gt;</span> 申诉问题列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="${path}/complaintProblemManage/list" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<form id="frm" action="complaintProblemManage/list" method="post" >
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			...
			<a class="btn btn-primary radius" data-title="添加申诉问题设置" data-href="javascript:;" onclick="pref_add('添加申诉问题设置','complaintProblemManage/newPrefToAdd','','')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加申诉问题设置</a>
		</span>
				...
				<c:forEach items="${pageBean.list}" var="list">
					<tr class="text-c">
						...
						<td class="f-14 td-manage">
							<a style="text-decoration:none" class="ml-5" onClick="pref_edit('参数设置编辑','complaintProblemManage/toEditPref','${list.id}','','')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
...
function pref_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		$.ajax({
			type: 'POST',
			url: 'complaintProblemManage/problemDel',
			dataType: 'json',
			data:{id:id},
