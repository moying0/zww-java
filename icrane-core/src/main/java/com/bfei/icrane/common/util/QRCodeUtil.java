...
public class QRCodeUtil {
    ...
    public static final String shareIMGversion = "1_3";
    ...
    public static void main(String[] args) throws WriterException {
        File logoFile = new File("E:/resources/logo.png");
        File QrCodeFile = new File("C:/Users/SUN/Desktop/05.png");
        String url = "http://dev.365zhuawawa.com/test/";
        //String note = "访问百度连接";
    ...
    public static void drawLogoQRCode(File logoFile, File codeFile, String qrUrl, String note) {
        try {
            ...
            if (Objects.nonNull(logoFile) && logoFile.exists()) {
                ...
                // 开始绘制logo图片
                g.drawImage(logo, width * 64 / 200, height * 64 / 200, width * 36 / 100, height * 36 / 100, null);
                g.dispose();
                logo.flush();
            }
    ...
    public static String myDrawLogoQRCode(File logoFile, String qrUrl, String note) {
        try {
            ...
            if (Objects.nonNull(logoFile) && logoFile.exists()) {
                ...
                BufferedImage logo = ImageIO.read(logoFile);
                // 开始绘制logo图片
                g.drawImage(logo, width * 70 / 200, height * 70 / 200, width * 30 / 100, height * 30 / 100, null);
                g.dispose();
                logo.flush();
            }
            ...
            String newFileUrl = AliyunServiceImpl.getInstance().generatePresignedUrl(ossBucketName, NewFileKey, 10 * 24 * 365).toString();
            return newFileUrl;
        } catch (Exception e) {
            e.printStackTrace();
        }
